...
The data discussed in this manuscript has been converted to an open access data article and is available <p><a href="https://kishanbellur.github.io/publication/bellur_2022a">here</a></p>. It contains a link to a Mendelay data repository where the entire cryo/neutron dataset can be accessed.